...
describe('hr-policy-drafter', () => {
  it('returns typed output', async () => {
    const r = await createHrPolicyDrafterAgent({ adapter: model({"title":"doc","sections":[{"heading":"h","body":"b","citations":[]}],"gaps":[],"openQuestions":[]}) }).run('sample input for hr-policy-drafter')

...
import { createFraudInvestigatorAgent } from './agents/fintech-fraud-investigator/agent'

const agent = createFraudInvestigatorAgent({ adapter: openai({ apiKey: process.env.OPENAI_API_KEY!, model: 'gpt-4o' }) })
